      ...
      <v-card class="pa-3 mb-3">
        <div id="printDeal">
          ...
          <p>
            ...
            на субсчёт Продавца открытый в расчетной организации ЗАО
            «Центральный депозитарий» в срок, установленный Биржевой сделкой.<br />
          ...
          <p>
            ...
            заменить на Товар надлежащего качества в ______ обоснованной
            претензии Покупателя. <br />
            дневный срок с момента получения <br />
            6.3. При просрочке сроков оплаты Товара, установленных Биржевой
            сделкой, Покупатель обязуется оплатить Продавцу пеню в размере % от
            суммы, подлежащей оплате за каждый день просрочки. <br />
